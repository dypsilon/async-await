...
async function isCommentingEnabled(id) {
...
async function isUserAllowedToComment(userId) {
...
async function addComment(comment) {
  let [commentingEnabled, userCanComment] = await Promise.all([
  ...
  const result = await insertComment(comment.post, comment.user, comment.message);
